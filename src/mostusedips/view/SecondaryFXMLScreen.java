...
/**
 * Extending classes should set the close button, and stage and scene to come back to after the close button has been clicked.
 *
 */
public abstract class SecondaryFXMLScreen
{
     ...
     * @param stage - stage to come back to after the close button has been clicked
     * @param scene - scene to come back to after the close button has been clicked
     */
